    ...
    if (window.self !== window.top) {
      ...
      warningDiv.innerHTML = `
        <style>
          ...
          .warning-title { font-size: 24px; font-weight: bold; margin-bottom: 10px; }
          .warning-desc { font-size: 14px; color: #aaa; margin-bottom: 20px; }
          .warning-link {
            display: inline-block; padding: 10px 20px; background: #007bff;
            color: #fff; text-decoration: none; border-radius: 4px; font-size: 14px;
          }
          .warning-link:hover { background: #0056b3; }
        </style>

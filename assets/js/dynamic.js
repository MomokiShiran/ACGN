...
const genSiteCard = site => {
  const iconUrl = site.icon ? `${BASE_URL}/${site.icon}` : `${BASE_URL}/assets/images/favicon.png`;
  ...
  return (
    ...
    '<a href="' + BASE_URL + '/sites/detail.html?id=' + site.id + '" target="_blank" data-id="' + site.id + '" data-url="' + site.url + '" class="card no-c mb-4 site-' + site.id + '" data-bs-toggle="tooltip" data-bs-placement="bottom" title="' + site.description + '" rel="noopener noreferrer">' +
    ...
    '<img loading="lazy" src="' + iconUrl + '" onerror="this.src=\'' + BASE_URL + '/assets/images/favicon.png\'"></div>' +
...
const genFriendLinks = () =>
  ...
  '<a href="' + BASE_URL + '/friends/index.html" target="_blank" title="更多链接" rel="noopener noreferrer" class="friendlink-link">更多链接</a>' +
  '</div></div>';
